    ...
    while not rospy.is_shutdown():
        ...
        if is_stucked and steering_predictor.front_limit_speed < 1.:
            ...
            if travel_distance < move_back_distance:
                ...
                lane_follow_msg.lane_follow_vel.angular.z = -0.07  # -0.05
        ...
        if try_to_escape:
            if (steering_predictor.contermet - begin_contermet_escape < 1.5) and (steering_predictor.front_limit_speed < 2):
